        ...
        <div class="container">
            <div class="navbar-header">
                ...
                @if (empty($account) || !$account->hasFeature(FEATURE_WHITE_LABEL))
                    ...
                    <a class="navbar-brand" href="https://marcorombach.de" target="_blank"><!--<img
                                src="{{ asset('images/invoiceninja-logo.png') }}" style="height:27px">-->Marco Rombach</a>
                @endif
            </div>
...
<footer id="footer" role="contentinfo">
    ...
    <div class="bottom">
        <div class="wrap">
            @if (empty($account) || !$account->hasFeature(FEATURE_WHITE_LABEL))
                <div class="copy">Copyright &copy;{{ date('Y') }} Marco Rombach.  All rights reserved.</div>
            @endif
        </div><!-- .wrap -->
    </div><!-- .bottom -->
</footer><!-- #footer -->
